...
// This creates a new reservation as a post to the database
...
// This reads a reservation by reservation_id
export async function readReservation(reservation_id, signal) {
  const url = new URL(`${API_BASE_URL}/reservations/${reservation_id}`);
  return await fetchJson(url, { headers, signal }, []);
}

// This lists all existing tables in the database
export async function listTables(signal) {
  const url = new URL(`${API_BASE_URL}/tables`);
  return await fetchJson(url, { headers, signal }, []);
}

// This posts a new table to the database
...
// This function finishes a table by table_id
...
// This fnuction finds matching reservations by mobile_number
...
// This function updates reservation
